...
def load_policy(
    ...
    checkpoint = torch.load(
        weight_path, map_location=torch_device, weights_only=True
    )
    ...
    model.eval()
    return LoadedPolicy(algo=algo, model=model, device=torch_device, checkpoint=checkpoint)
